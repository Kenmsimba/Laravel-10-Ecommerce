                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>phone:</b> <span class="font-light"> 0707079093 </span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light"> Nairobi, Kenya </span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> contact@kenmedia.ke</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2024, Ken Media.</p>
                    </div>
                </div>
            </div>
        </div>
